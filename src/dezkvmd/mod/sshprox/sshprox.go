...
import (
	...
	"imuslab.com/dezkvm/dezkvmd/mod/sshprox/reverseproxy"
	"imuslab.com/dezkvm/dezkvmd/mod/sshprox/websocketproxy"
)

/*
	SSH Proxy

	This is a tool to bind gotty into DezKVM
...
func (m *Manager) NewSSHProxy(binaryRoot string) (*Instance, error) {
	...
	if !fileExists(filepath.Join(filepath.Dir(execPath), ".gotty")) {

...
func generateThumbnailForRAW(fsh *FileSystemHandler, cacheFolder string, file string, generateOnly bool) (string, error) {
...
func RenderRAWImage(fsh *FileSystemHandler, file string) ([]byte, error) {
	fshAbs := fsh.FileSystemAbstraction

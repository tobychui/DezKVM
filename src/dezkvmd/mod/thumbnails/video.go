...
func generateThumbnailForVideo(fsh *FileSystemHandler, cacheFolder string, file string, generateOnly bool) (string, error) {
...
// pkg_exists reports whether a helper binary is callable. arozos asked the
// package manager; here a PATH lookup is both cheaper and correct for the
// static ffmpeg builds these boards often ship with.
